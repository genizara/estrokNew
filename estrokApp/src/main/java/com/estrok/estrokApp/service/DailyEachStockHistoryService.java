...
@Service
public class DailyEachStockHistoryService {
	
	MainMapper mapper;
	
	@Autowired
	public DailyEachStockHistoryService(MainMapper mapper) {
		this.mapper = mapper;
	}
...
//			List<String> stockCodeList = mapper.getCodeList2();
			List<String> stockCodeList = mapper.getCodeList();
			...
			for(String code : stockCodeList) {
				...
				for( int targetYear : yearArr ) {
						...
						for(int page = 1; page < totalPageTry; page ++) {
